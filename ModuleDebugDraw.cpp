...
update_status  ModuleDebugDraw::Update()
{
    ...
    dd::xzSquareGrid(-50, 50, 0.0f, 1.0f, dd::colors::YellowGreen);
    dd::xzSquareGrid(-50, 50, 0.0f, 0.5f, dd::colors::DarkGreen);

    Draw(App->GetCamera()->GetViewMatrix(), App->GetCamera()->GetProjectionMatrix(), SCREEN_WIDTH, SCREEN_HEIGHT);
